 ...
 * @author USER1
 */
public class Clubleaderdashboard1 extends javax.swing.JFrame {
      
    /**
     * Creates new form AdminDashboard
     */
    public Clubleaderdashboard1() {
    initComponents();}
    ...
    private void initComponents() {
        ...
        attendancebtn.setFont(new java.awt.Font("Microsoft PhagsPa", 1, 20)); // NOI18N
        attendancebtn.setForeground(new java.awt.Color(0, 153, 255));
        attendancebtn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/AYM/view/image/pngwing.com (6).png"))); // NOI18N
        ...
        jPanel2.add(attendancebtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 410, -1, 55));
        ...
        jPanel2.add(logoutbtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 510, 200, 60));
        ...
        jPanel2.add(eventbtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 320, 190, 50));
    ...
    private void userbtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_userbtnActionPerformed
     Usermanagementpageclubleader umpc = new Usermanagementpageclubleader();
     umpc.setVisible(true);
    ...
    private void attendancebtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_attendancebtnActionPerformed
         attendancepageclubleader ampc = new attendancepageclubleader();
         ampc.setVisible(true);
    ...
    private void eventbtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_eventbtnActionPerformed
          eventsmanagementpageclubleader empc = new eventsmanagementpageclubleader();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Clubleaderdashboard1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Clubleaderdashboard1().setVisible(true);
            }
        });
    }
