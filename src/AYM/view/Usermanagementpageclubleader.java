 ...
 * @author USER1
 */
public class Usermanagementpageclubleader extends javax.swing.JFrame {
...
private void addColumnsHeaderNameToTable(){
     ...
     */
    public Usermanagementpageclubleader() {
        initComponents();
    ...
    private void refreshbtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_refreshbtnActionPerformed
     try {
        ...
        List<AYmember> memberList = userDAO.retrieveAllRegularUsers(); 
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Usermanagementpageclubleader.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Usermanagementpageclubleader().setVisible(true);
            }
        });
    }
